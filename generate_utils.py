...
class VerificationUtils:
    ...
    def mutate_test(
        ...
        c_to_wasi = subprocess.run(
            ...
            f"/home/wsh-v22/wasi-sdk-12/wasi-sdk-12.0/bin/clang{cpp} -fno-exceptions --sysroot=/home/wsh-v22/wasi-sdk-12/wasi-sdk-12.0/share/wasi-sysroot -o main.wasm {filename}",
            shell=True,
            capture_output=True,
            text=True,
            cwd=project_path,
        )
        print("c_to_wasi completed")
        ...
        wasi_to_rust = subprocess.run(
            ...
            f"cargo run --manifest-path /home/wsh-v22/rWasm/Cargo.toml --release -- main.wasm out-rwasm-original --prevent-reformat --wasi-executable",
            shell=True,
            capture_output=True,
            text=True,
            cwd=project_path,
        )
        print("wasi_to_rust completed")
        ...
        c_to_wasi = subprocess.run(
            ...
            f"/home/wsh-v22/wasi-sdk/wasi-sdk-12.0/bin/clang{cpp} -fno-exceptions --sysroot=/home/wsh-v22/test/wasi-sdk-12/wasi-sdk-12.0/share/wasi-sysroot -o main.wasm {filename.replace(file_ext, f'_mutated{file_ext}')}",
        ...
        wasi_to_rust = subprocess.run(
            ...
            f"cargo run --manifest-path /home/wsh-v22/rWasm/Cargo.toml --release -- main.wasm out-rwasm-mutated --prevent-reformat --wasi-executable",
            shell=True,
            capture_output=True,
            text=True,
            cwd=project_path,
        ...
        wasi_to_rust = subprocess.run(
            ...
            f"cargo run --manifest-path /home/wsh-v22/rWasm/Cargo.toml --release -- main.wasm out-rwasm-bolero --prevent-reformat --wasi-executable",
            shell=True,
            capture_output=True,
            text=True,
            cwd=project_path,
...
class GenerateUtils:
    ...
    def get_fn_args(self, code):
        ...
        fn_args_names = [
            ...
            if len(arg.split(arg_separator)) > arg_name_index
        ]
    ...
    def c_code_process(self, file_dir, package_name, file_name, f_filled, args_types):
        function_call = None  # or an empty string, depending on your use case
        if "cpp" in file_dir:
            file_ext = ".cpp"
        else:
            file_ext = ".c"
